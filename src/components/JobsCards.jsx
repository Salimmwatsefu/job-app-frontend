...
const JobsCards = () => {
    ...
    return (
        <section className='bg-[#FCF5EB]'>
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <h2 class="text-center text-[#BA4B2F] text-4xl mb-20 font-bold tracking-tight sm:text-5xl">
      Read trusted reviews from our customers
          ...
          >
            <div className="mb-8 sm:break-inside-avoid hidden md:block">
              <blockquote className="rounded-xl bg-[#BA4B2F] p-6 shadow">
              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                <div className="text-sm">
                  <p className="font-medium text-[#BA4B2F]">Gladis Lennon</p>
                  <p className=" text-[#BA4B2F]">Head of SEO</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8 sm:break-inside-avoid hidden md:block">
              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                <div className="text-sm">
                  <p className="font-medium text-[#BA4B2F]">Gladis Lennon</p>
                  <p className="mt-1 text-[#BA4B2F]">Head of SEO</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8 sm:break-inside-avoid">
              ...
              <div className="mt-4 flex items-center gap-4">
                ...
                <div className="text-sm text-[#BA4B2F]">
                  <p className="font-medium text-[#BA4B2F]">Gladis Lennon</p>
                  <p className="mt-1 text-[#BA4B2F]">Head of SEO</p>
                </div>
              </div>
