...
function Blog() {
  return (
    <div class="bg-slate-50">
      <h2 className="font-semibold flex justify-center mb-4 pt-10">Latest News</h2>
      ...
      <div className="flex gap-10 justify-center pb-10 mt-14">
        <div className="w-60 bg-white hover:scale-105 ">
          <img
        ...
        <div className="w-60 bg-white hover:scale-105">
          <img
            ...
            className=""
          />
          <h4 className="text-gray-700 my-2 ml-2">How to Write the Perfect Resume</h4>
          <p className="text-xs text-gray-400 mb-2 ml-2">
            Education & E-learning, Information Technology, Job hunt Nulla ut
            tortor
          </p>
        ...
        <div className="w-60 bg-white hover:scale-105 ">
          <img
            ...
            className=""
          />
          <h4 className="text-gray-700 my-2 ml-2">Soft Skills Needed to Work in a Team</h4>
          <p className="text-xs text-gray-400 mb-2 ml-2">
            Education & E-learning, Information Technology, Job hunt Nulla ut
            tortor
          </p>
